...
export const S = {
  ...
  chipRow: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, marginBottom: 12 },
  chip: { padding: "12px 8px", background: "#f0e0c4", border: "1px solid #c4a880", borderRadius: 10, color: "#450206", fontSize: 14, fontWeight: 600, cursor: "pointer", fontFamily: F, letterSpacing: "0.8px", textAlign: "center", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" },
